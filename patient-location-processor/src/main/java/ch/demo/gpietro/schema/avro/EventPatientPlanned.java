...
public class EventPatientPlanned extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2302379551285920114L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"EventPatientPlanned\",\"namespace\":\"ch.demo.gpietro.schema.avro\",\"fields\":[{\"name\":\"patientId\",\"type\":\"long\"},{\"name\":\"episodeOfCareId\",\"type\":\"long\"},{\"name\":\"wardId\",\"type\":\"long\"},{\"name\":\"date\",\"type\":{\"type\":\"long\",\"connect.version\":1,\"connect.name\":\"org.apache.kafka.connect.data.Timestamp\",\"logicalType\":\"timestamp-millis\"}}],\"version\":\"1\"}");
...
static {
   ...
   */
  public static ch.demo.gpietro.schema.avro.EventPatientPlanned.Builder newBuilder() {
    return new ch.demo.gpietro.schema.avro.EventPatientPlanned.Builder();
  }
   ...
   * @return A new EventPatientPlanned RecordBuilder
   */
  public static ch.demo.gpietro.schema.avro.EventPatientPlanned.Builder newBuilder(ch.demo.gpietro.schema.avro.EventPatientPlanned.Builder other) {
    if (other == null) {
      return new ch.demo.gpietro.schema.avro.EventPatientPlanned.Builder();
    } else {
      return new ch.demo.gpietro.schema.avro.EventPatientPlanned.Builder(other);
    }
  }
   ...
   * @return A new EventPatientPlanned RecordBuilder
   */
  public static ch.demo.gpietro.schema.avro.EventPatientPlanned.Builder newBuilder(ch.demo.gpietro.schema.avro.EventPatientPlanned other) {
    if (other == null) {
      return new ch.demo.gpietro.schema.avro.EventPatientPlanned.Builder();
    } else {
      return new ch.demo.gpietro.schema.avro.EventPatientPlanned.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EventPatientPlanned>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(ch.demo.gpietro.schema.avro.EventPatientPlanned.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(ch.demo.gpietro.schema.avro.EventPatientPlanned other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.patientId)) {
        this.patientId = data().deepCopy(fields()[0].schema(), other.patientId);
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.demo.gpietro.schema.avro.EventPatientPlanned.Builder setPatientId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.demo.gpietro.schema.avro.EventPatientPlanned.Builder clearPatientId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.demo.gpietro.schema.avro.EventPatientPlanned.Builder setEpisodeOfCareId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.demo.gpietro.schema.avro.EventPatientPlanned.Builder clearEpisodeOfCareId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.demo.gpietro.schema.avro.EventPatientPlanned.Builder setWardId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.demo.gpietro.schema.avro.EventPatientPlanned.Builder clearWardId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.demo.gpietro.schema.avro.EventPatientPlanned.Builder setDate(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.demo.gpietro.schema.avro.EventPatientPlanned.Builder clearDate() {
