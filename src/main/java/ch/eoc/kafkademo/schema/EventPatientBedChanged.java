...
public class EventPatientBedChanged extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2843477298553892813L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"EventPatientBedChanged\",\"namespace\":\"ch.eoc.kafkademo.schema\",\"fields\":[{\"name\":\"patientId\",\"type\":\"long\"},{\"name\":\"treatmentId\",\"type\":\"long\"},{\"name\":\"bedId\",\"type\":\"long\"}],\"version\":\"1\"}");
   ...
   */
  public EventPatientBedChanged(java.lang.Long patientId, java.lang.Long treatmentId, java.lang.Long bedId) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: bedId = (java.lang.Long)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public static ch.eoc.kafkademo.schema.EventPatientBedChanged.Builder newBuilder() {
    return new ch.eoc.kafkademo.schema.EventPatientBedChanged.Builder();
  }
   ...
   * @return A new EventPatientBedChanged RecordBuilder
   */
  public static ch.eoc.kafkademo.schema.EventPatientBedChanged.Builder newBuilder(ch.eoc.kafkademo.schema.EventPatientBedChanged.Builder other) {
    if (other == null) {
      return new ch.eoc.kafkademo.schema.EventPatientBedChanged.Builder();
    } else {
      return new ch.eoc.kafkademo.schema.EventPatientBedChanged.Builder(other);
    }
  }
   ...
   * @return A new EventPatientBedChanged RecordBuilder
   */
  public static ch.eoc.kafkademo.schema.EventPatientBedChanged.Builder newBuilder(ch.eoc.kafkademo.schema.EventPatientBedChanged other) {
    if (other == null) {
      return new ch.eoc.kafkademo.schema.EventPatientBedChanged.Builder();
    } else {
      return new ch.eoc.kafkademo.schema.EventPatientBedChanged.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EventPatientBedChanged>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(ch.eoc.kafkademo.schema.EventPatientBedChanged.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[2], other.bedId)) {
        this.bedId = data().deepCopy(fields()[2].schema(), other.bedId);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(ch.eoc.kafkademo.schema.EventPatientBedChanged other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.patientId)) {
        this.patientId = data().deepCopy(fields()[0].schema(), other.patientId);
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.eoc.kafkademo.schema.EventPatientBedChanged.Builder setPatientId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.eoc.kafkademo.schema.EventPatientBedChanged.Builder clearPatientId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.eoc.kafkademo.schema.EventPatientBedChanged.Builder setTreatmentId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.eoc.kafkademo.schema.EventPatientBedChanged.Builder clearTreatmentId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.eoc.kafkademo.schema.EventPatientBedChanged.Builder setBedId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.eoc.kafkademo.schema.EventPatientBedChanged.Builder clearBedId() {
    ...
    public EventPatientBedChanged build() {
      try {
        ...
        record.bedId = fieldSetFlags()[2] ? this.bedId : (java.lang.Long) defaultValue(fields()[2]);
        return record;
